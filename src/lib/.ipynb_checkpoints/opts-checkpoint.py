...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--load_model', default='../exp/mot/sportsmot_ch_hrnet18/model_last.pth',
                             help='path to pretrained model')
...
#                              help='path to pretrained model')
    ...
    self.parser.add_argument('--lr_step', type=str, default='10',
    ...
    #                          help='max number of output objects.') # 调整输出目标的个数，可以调整为10
    ...
    self.parser.add_argument('--val_sportsmot', default=True, help='val mot17')
    ...
    self.parser.add_argument('--match_thres', type=float, default=0.4, help='confidence thresh for tracking')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/workspace')
